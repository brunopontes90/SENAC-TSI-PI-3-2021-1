...
<body class="container bg-secondary mb-5">
    ...
    <h1 class="text-center text-uppercase mt-5 text-white fw-bold">Editar Produto</h1>
    <div class="container bg-dark p-5" style="box-shadow: 2px 3px 3px 0px #FFFFFF">
        <form class="text-white" method="POST" action="{{ Route('product.update', $product->id) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row">
            ...
            <div class="row">
                <span class="form-label text-uppercase fs-5 mt-3">Preço:</span>
                <input type="text" name="price" class="form-control" value="{{ $product->price }}">
            </div>

            <div class="row">
                <span class="form-label text-uppercase fs-5 mt-3">Descrição:</span>
                <input type="text" name="desc" class="form-control" value="{{ $product->desc }}">
            </div>

            <div class="row">
            <span class="form-label fs-5 text-uppercase mt-3">Categoria:</span>
